...
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ACCELEROMETER_X;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ACCELEROMETER_Y;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ACCELEROMETER_Z;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ADVANCED_SCENE_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_AF_AREA_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_AF_ASSIST_LAMP;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_AUDIO;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_BABY_AGE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_BABY_AGE_1;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_BABY_NAME;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_BRACKET_SETTINGS;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_BURST_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CAMERA_ORIENTATION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CITY;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CLEAR_RETOUCH;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_COLOR_EFFECT;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_COLOR_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CONTRAST;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CONTRAST_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_CONVERSION_LENS;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_COUNTRY;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_EXIF_VERSION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FACE_DETECTION_INFO;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FACE_RECOGNITION_INFO;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FIRMWARE_VERSION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FLASH_CURTAIN;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FLASH_FIRED;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FLASH_WARNING;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_FOCUS_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_HDR;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_IMAGE_STABILIZATION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_INTELLIGENT_D_RANGE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_INTELLIGENT_EXPOSURE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_INTELLIGENT_RESOLUTION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_INTERNAL_SERIAL_NUMBER;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_LANDMARK;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_LENS_FIRMWARE_VERSION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_LOCATION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_LONG_EXPOSURE_NOISE_REDUCTION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_MACRO_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_MAKERNOTE_VERSION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_NOISE_REDUCTION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_OPTICAL_ZOOM_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_PHOTO_STYLE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_PITCH_ANGLE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_QUALITY_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_RECORD_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ROLL_ANGLE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_ROTATION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_SCENE_MODE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_SELF_TIMER;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_SHADING_COMPENSATION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_SHUTTER_TYPE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_STATE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_SWEEP_PANORAMA_DIRECTION;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TEXT_STAMP;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TEXT_STAMP_1;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TEXT_STAMP_2;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TEXT_STAMP_3;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TIMER_RECORDING;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TITLE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TOUCH_AE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TRANSFORM;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_TRANSFORM_1;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_UNKNOWN_DATA_DUMP;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_UPTIME;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_WHITE_BALANCE;
import static com.drew.metadata.exif.makernotes.PanasonicMakernoteDirectory.TAG_WORLD_TIME_LOCATION;
