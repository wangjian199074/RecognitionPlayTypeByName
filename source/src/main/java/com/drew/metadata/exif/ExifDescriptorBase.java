...
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_CFA_PATTERN;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_CFA_PATTERN_2;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_CFA_REPEAT_PATTERN_DIM;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_COLOR_SPACE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_COMPONENTS_CONFIGURATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_COMPRESSED_AVERAGE_BITS_PER_PIXEL;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_COMPRESSION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_CONTRAST;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_CUSTOM_RENDERED;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_DIGITAL_ZOOM_RATIO;
...
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_EXIF_VERSION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_EXPOSURE_BIAS;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_EXPOSURE_MODE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_EXPOSURE_PROGRAM;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_EXPOSURE_TIME;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FILE_SOURCE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FILL_ORDER;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FLASH;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FLASHPIX_VERSION;
...
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FOCAL_PLANE_RESOLUTION_UNIT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FOCAL_PLANE_X_RESOLUTION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_FOCAL_PLANE_Y_RESOLUTION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_GAIN_CONTROL;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_IMAGE_HEIGHT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_IMAGE_WIDTH;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_INTEROP_INDEX;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_INTEROP_VERSION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_ISO_EQUIVALENT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_JPEG_PROC;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_LENS_SPECIFICATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_MAX_APERTURE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_METERING_MODE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_NEW_SUBFILE_TYPE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_ORIENTATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_PHOTOMETRIC_INTERPRETATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_PLANAR_CONFIGURATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_REFERENCE_BLACK_WHITE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_RESOLUTION_UNIT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_ROWS_PER_STRIP;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SAMPLES_PER_PIXEL;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SATURATION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SCENE_CAPTURE_TYPE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SCENE_TYPE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SENSING_METHOD;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SENSITIVITY_TYPE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SHARPNESS;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SHUTTER_SPEED;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_STRIP_BYTE_COUNTS;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SUBFILE_TYPE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SUBJECT_DISTANCE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_SUBJECT_DISTANCE_RANGE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_THRESHOLDING;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_USER_COMMENT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WHITE_BALANCE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WHITE_BALANCE_MODE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WIN_AUTHOR;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WIN_COMMENT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WIN_KEYWORDS;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WIN_SUBJECT;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_WIN_TITLE;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_X_RESOLUTION;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_YCBCR_POSITIONING;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_YCBCR_SUBSAMPLING;
import static com.drew.metadata.exif.ExifDirectoryBase.TAG_Y_RESOLUTION;
