...
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_COLOR_ADJUSTMENT_MODE;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_DIGITAL_ZOOM;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_DIGITAL_ZOOM_ON;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_FLASH_MODE;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_FLICKER_REDUCE;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_LIGHT_SOURCE_SPECIAL;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_MACRO;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_OPTICAL_ZOOM_ON;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_QUICK_SHOT;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_RECORD_SHUTTER_RELEASE;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_RESAVED;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_SANYO_QUALITY;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_SCENE_SELECT;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_SELF_TIMER;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_SEQUENCE_SHOT_INTERVAL;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_SEQUENTIAL_SHOT;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_VOICE_MEMO;
import static com.drew.metadata.exif.makernotes.SanyoMakernoteDirectory.TAG_WIDE_RANGE;
